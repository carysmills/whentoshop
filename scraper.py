...
scrapeData(coords=locations.ontario_burlington)
...
scrapeData(coords=locations.bc_whiterocksouthsurrey)
scrapeData(coords=locations.ontario_peterborough)
scrapeData(coords=locations.ontario_hamilton_waterdown)
scrapeData(coords=locations.bc_vancouver_champlainheights)
scrapeData(coords=locations.ontario_waterloo)
scrapeData(coords=locations.ontario_toronto_scarboroughvillage)
scrapeData(coords=locations.ontario_ottawa_pineview)
scrapeData(coords=locations.ontario_toronto_annex)